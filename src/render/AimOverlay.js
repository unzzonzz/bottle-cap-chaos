 ...
 *
 * 2.5 는 아트 디렉션이 들어오기 전에 이 파일이 쓰던 값이다 — 당시의
 * `CONE_MIN_RADII`, 즉 당김이 0 일 때의 바닥이었고 콘은 거기서부터 자랐다.
 * 자라는 것을 없앤 지금 남는 것은 그 바닥이고, 짧다는 것이 요점이다: 콘은
 * 뚜껑 바로 앞의 오차만 말하고 어디까지 굴러갈지는 말하지 않는다.
 */
const CONE_FIXED_RADII = 2.5;
